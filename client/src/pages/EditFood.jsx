...
import { ArrowLeft, Save, Image as ImageIcon, Tag, FileText, Loader } from 'lucide-react';
...
const EditFood = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await API.put(`/api/foods/${id}`, formData);
        ...
        <div className="min-h-screen bg-[#FDFBF7] py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-[2.5rem] shadow-sm p-10 md:p-14 border border-gray-100">
                    <h1 className="text-3xl font-bold text-primary-dark mb-10 tracking-tight">Edit Food Item</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div>
                            ...
                            {formData.image && (
                                <div className="mt-4 p-2 bg-gray-100 rounded-2xl w-32 h-32 overflow-hidden">
